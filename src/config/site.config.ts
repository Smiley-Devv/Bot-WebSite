...
export const siteConfig: SiteConfig = {
  ...
  discord: {
    clientId: "YOUR_DISCORD_CLIENT_ID", // Replace with your actual Discord application client ID
    redirectUri: window.location.origin + "/#/dashboard/callback", // Updated for hash router
